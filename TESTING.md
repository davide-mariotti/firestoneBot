...
| 18 | Scarab's Game (omaggio) | `[scarabgamefreetokentask]` | 60 | Taverna → Scarab's Game → shop: reclama l'omaggio giornaliero gratuito nel tab Saldi. **Nota 2026-09-18**: la navigazione è stata corretta insieme al fix di Gamer Quest - non si passa più da "menus/Tavern", ma dal popup "TavernSelection" (Town → edificio tavern → carta "scarabGame" direttamente). Non ancora testato dal vivo con questo nuovo percorso. |
| 19 | Pharaoh's Vault + spin | `[pharaohsvaulttask]` | 60 | Gira la slot con i Noble Token gratuiti, apre il Pharaoh's Vault quando ci sono abbastanza Ancient Coin. **Nota 2026-09-18**: stessa correzione di navigazione di cui sopra (riga 18). Non ancora testato dal vivo con questo nuovo percorso. |
