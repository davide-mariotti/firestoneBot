...
public class EmpowerTask : BotTask
{
    ...
    public override IEnumerator Execute()
    {
        ...
        // otherwise. Unlike every other task's notification, this one has no v1 precedent to
        // cross-check (v1 never used a notification for this feature) - see the path comment.
