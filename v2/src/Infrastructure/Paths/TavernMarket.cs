...
/// <summary>
///     Exchanges beer or gems for game tokens, opened from Tavern via TavernLoc.OpenMarketBtn. No v1
///     precedent. IMPORTANT: the "gameToken" item (5 tokens) has TWO payment buttons - one priced in
